...
# Load Sound File
pop_sound = pygame.mixer.Sound(r"C:\Users\sange\OneDrive\Desktop\virtual balloon Buster\BalloonPopGame-main\popping tone.mp3")  # Replace with the path to your sound file
...
current_balloon_image = balloon_image1
    ...
    if timeRemain < 0:
        ...
        if hands:
            ...
            if rectBalloon.collidepoint(x, y):
                ...
                # Switch to the other balloon image
                current_balloon_image = balloon_image2 if current_balloon_image == balloon_image1 else balloon_image1
